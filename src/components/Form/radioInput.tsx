...
export const RadioInput = ({
  ...
  return(
    <fieldset
    className={clsx(
      "rounded-md cursor-pointer w-1/2 py-4 ring-1 ring-borderGray/20 hover:bg-opacity-80 active:scale-105",
      {
        "bg-green-300 text-white": type === "income" && selectedType === "income",
